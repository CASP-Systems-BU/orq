...
using namespace secrecy::service::grpc_service::replicated_3pc;init_mpc_benchmarking(secrecy::service::benchmarking);
...
int main(int argc, char **argv) {
    ...
    secrecy::service::runTime->execution_finished.unlock();
    return 0;
}