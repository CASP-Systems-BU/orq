...
int main(int argc, char** argv) {
    ...
    std::vector<Vector<T>> data = {
        ret_flag, line_status, sum_quantity, sum_extended_price,
        sum_discounted_price, sum_charge, sum_discount, count};
    ...
    main_table["SumExtendedPrice"] = main_table["SumExtendedPrice"] + other_table["SumExtendedPrice"];
    main_table["SumDiscountedPrice"] = main_table["SumDiscountedPrice"] + other_table["SumDiscountedPrice"];
    ...
    if (pid == 0) {
        single_cout_nonl("aq: "); print(aq_col);
        single_cout_nonl("aq: "); print(ad_col);
        single_cout_nonl("aq: "); print(ap_col);
    }
