...
void orq_runtime_init(int argc, char** argv, const int& partiesNum,
...
namespace fantastic_4pc {
    ...
    init_mpc_system(orq::MPICommunicator, orq::random::PRGAlgorithm, orq::Fantastic_4PC,
                    orq::Fantastic_4PC_Factory);
...
namespace replicated_3pc {
    ...
    init_mpc_system(orq::MPICommunicator, orq::random::PRGAlgorithm, orq::Replicated_3PC,
                    orq::Replicated_3PC_Factory);
    init_mpc_functions(2);

    void orq_init(int argc, char** argv) {
        std::vector<std::set<int>> groups = orq::ProtocolBase::generateRandomnessGroups(3, 2, 1);
        orq_runtime_init<ProtocolFactory, MPICommunicatorFactory>(argc, argv,
                                                                  Protocol_8::parties_num, groups);
    }
}  // namespace replicated_3pc
...
namespace beaver_2pc {
    ...
    init_mpc_system(orq::MPICommunicator, orq::random::PRGAlgorithm, orq::Beaver_2PC,
                    orq::Beaver_2PC_Factory);
    init_mpc_functions(1);

    void orq_init(int argc, char** argv) {
        std::vector<std::set<int>> groups = orq::ProtocolBase::generateRandomnessGroups(2, 2, 1);
        orq_runtime_init<ProtocolFactory, MPICommunicatorFactory>(argc, argv,
                                                                  Protocol_8::parties_num, groups);
    }
}  // namespace beaver_2pc
...
namespace fantastic_4pc {
    init_mpc_types(int, orq::Vector, std::vector, orq::EVector, 3);
    init_mpc_system(orq::NoCopyCommunicator, orq::random::PRGAlgorithm, orq::Fantastic_4PC,
                    orq::Fantastic_4PC_Factory);
    init_mpc_functions(3);
...
namespace replicated_3pc {
    init_mpc_types(int, orq::Vector, std::vector, orq::EVector, 2);
    init_mpc_system(orq::NoCopyCommunicator, orq::random::PRGAlgorithm, orq::Replicated_3PC,
                    orq::Replicated_3PC_Factory);
    init_mpc_functions(2);
...
namespace beaver_2pc {
    init_mpc_types(int, orq::Vector, std::vector, orq::EVector, 1);
    init_mpc_system(orq::NoCopyCommunicator, orq::random::PRGAlgorithm, orq::Beaver_2PC,
                    orq::Beaver_2PC_Factory);
    init_mpc_functions(1);
