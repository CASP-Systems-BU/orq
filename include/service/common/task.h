#ifndef SECRECY_SERVICE_TASK_H
#define SECRECY_SERVICE_TASK_H

#include <functional>

// Do not give any thread less than this amount of work (unless that's all
// that's left)
//
// User may specify, in which case the default is ignored.
//
// Note: this MUST be a multiple of 128 due to some internal alignment
// requirements
