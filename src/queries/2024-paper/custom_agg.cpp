...
int main(int argc, char** argv) {
    ...
    T1.aggregate({ENC_TABLE_VALID, "[person]"}, {{"percentage", "percentage", sum<A>}});
    ...
    T12.aggregate({ENC_TABLE_VALID, "[disease]"}, {{"insCost", "insCost", sum<A>}});
    ...
    T123.aggregate({ENC_TABLE_VALID, "[class_]"}, {{"insCost", "insCost", sum<A>}});
