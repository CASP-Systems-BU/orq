...
cmake .. -DPROTOCOL -DUSE_DALSKOV_FANTASTIC_FOUR=ON
../scripts/run_experiment.sh -p 4 -s lan -c nocopy -n 17 -r 16-20 -T 17 -b 16384 -e 3 -x node ./micro_sorting > ~/results/orq-4pc.txt
cmake .. -DPROTOCOL -DUSE_DALSKOV_FANTASTIC_FOUR=OFF
